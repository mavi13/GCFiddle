...
QUnit.module("ScriptParser", function (hooks) {
	hooks.beforeEach(function (/* assert */) {
		var that = this; // eslint-disable-line no-invalid-this

		that.parser = new ScriptParser();
	});
...
QUnit.module("ScriptParser.lex", function (hooks) {
	hooks.beforeEach(function (/* assert */) {
		var that = this; // eslint-disable-line no-invalid-this
...
QUnit.module("ScriptParser.parse", function (hooks) {
	hooks.beforeEach(function (/* assert */) {
		var that = this; // eslint-disable-line no-invalid-this
...
QUnit.module("ScriptParser.evaluate", function (hooks) {
	hooks.beforeEach(function (/* assert */) {
		var that = this; // eslint-disable-line no-invalid-this
...
QUnit.module("ScriptParser.calculate", function (hooks) {
	hooks.beforeEach(function (/* assert */) {
		var that = this; // eslint-disable-line no-invalid-this

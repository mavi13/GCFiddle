...
QUnit.module("LatLng Properties", function (hooks) {
	...
	QUnit.test("find variables", function (assert) {
		...
		assert.strictEqual(oOut.script, "#text1 a=0 text2\na=0\n", "variable equals number between text");
